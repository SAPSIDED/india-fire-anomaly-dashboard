...
export function LiveClimateDashboard({ weather, alerts, loading, onSelectAlert }: { weather?: ClimateReading; alerts: PersistenceAlert[]; loading?: boolean; onSelectAlert?: (alert: PersistenceAlert) => void }) {
