...
import { GISSpatialVerificationModal } from "@/components/GISSpatialVerificationModal";
...
export default function Home() {
  ...
  return (
    <div className="fireguard-page" onPointerMove={moveThermalField}>
      ...
      {gisModalOpen && <GISSpatialVerificationModal selected={selected} state={selectedVerificationState} result={selectedVerification} onClose={() => { setGisModalOpen(false); setVerifierOpen(true); }} />}
